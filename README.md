...
Journal is a desktop app for reflective journaling. It's about simplicity, keeping your data local, and enhancing your journaling experience with AI.

![Journal app screenshot](./assets/cover.png)

## Getting started

1. Download the latest version of Journal from your Integrofy LLC distribution channel.
...
3. Finally open the application, create a new journal, and start your reflective journey.

### AI reflections (requires OpenAI API access, or Ollama for local AI)

Enhance your journaling experience by integrating OpenAI's GPT AI reflections into Journal. If you have access to OpenAI's GPT-4 API, you can use your API key to:
...
**How to set up AI features:** head over to [platform.openai.com/api-keys](https://platform.openai.com/api-keys) and create a new API key. Click the settings icon on the top-right corner of Journal and enter your secret API key into the API key field.
...
If you'd like to contribute to Journal, feel free to fork the repository, make your changes, and submit a pull request. Contributions are welcomed and appreciated, however this is an experimental project, so any changes and new features are merged into this distribution of Journal at Integrofy LLC's discretion.
...
Many thanks and appreciation to all these people and projects for their contributions to Journal.
