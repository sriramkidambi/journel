...
export default function CreateJournal() {
  ...
  const { createJournal } = useJournalsContext();
  ...
  const handleSubmit = () => {
    ...
    createJournal(name, path);
    navigate('/journal/' + name);
  };

  const renderJournals = () => {
    return journalsList.map((journal) => {
      const name = journal.split(/[/\\]/).pop();
      return (
        <div className={styles.journal} key={journal}>
    ...
    <div className={styles.frame}>
      <div className={styles.card}>
        <div className={styles.header}>
          <div className={styles.name}>Create a new journal</div>
        </div>
        ...
        <div className={styles.form}>
          <div className={styles.input}>
            <div className={styles.des}>
              ...
              Pick a name for your new journal
            </div>
            <input
              type="text"
          ...
          <div className={styles.input}>
            <div className={styles.des}>
              ...
              Pick a place to store this journal
            </div>
