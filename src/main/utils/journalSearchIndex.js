...
class JournalSearchIndex {
  ...
  initialize(journalPath, index) {
    this.journalPath = journalPath;
    this.index = this.loadIndex(journalPath, index);
    return this.index;
  }

  loadIndex(journalPath, index) {
    try {
  ...
  async saveIndex() {
    const indexPath = path.join(this.journalPath, this.indexFileName);
...
module.exports = new JournalSearchIndex();
